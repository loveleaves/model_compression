...
- [第5章 神经网络架构搜索](#第5章-神经网络架构搜索)
  - [5.1 神经网络架构搜索介绍](#51-神经网络架构搜索介绍)
  - [5.2 神经网络架构搜索的基本概念](#52-神经网络架构搜索的基本概念)
    - [5.2.1 基础网络模型回顾](#521-基础网络模型回顾)
    - [5.2.2 网络模块介绍](#522-网络模块介绍)
  - [5.3 搜索空间的介绍](#53-搜索空间的介绍)
    - [5.3.1 神经网络架构搜索的基本流程](#531-神经网络架构搜索的基本流程)
    - [5.3.2 搜索空间](#532-搜索空间)
    - [5.3.3 搜索空间与硬件设备之间的关系](#533-搜索空间与硬件设备之间的关系)
  - [5.4 搜索策略的介绍](#54-搜索策略的介绍)
  - [5.5 模型性能评估](#55-模型性能评估)
  - [5.6 以硬件为主的神经网络架构搜索](#56-以硬件为主的神经网络架构搜索)
  - [5.7 神经网络架构搜索的应用介绍](#57-神经网络架构搜索的应用介绍)
  - [5.8 实践](#58-实践)
...
示例代码： [神经网络架构搜索实践](notebook/1.NAS.ipynb)